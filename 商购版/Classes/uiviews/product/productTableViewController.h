...
@interface productTableViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,EGORefreshTableHeaderDelegate,CommandOperationDelegate,IconDownloaderDelegate>
{
