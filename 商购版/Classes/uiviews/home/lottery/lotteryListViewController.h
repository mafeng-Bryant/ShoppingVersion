...
@interface lotteryListViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,CommandOperationDelegate,IconDownloaderDelegate,EGORefreshTableHeaderDelegate,myImageViewDelegate,LoginViewDelegate>
{
...
@property(nonatomic,retain) NSMutableArray *lotteryItems;
