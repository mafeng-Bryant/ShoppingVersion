...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.listArray count] > 0 && indexPath.row < [self.listArray count]) {
        ...
        //标题
        cell.titleLabel.text = [productArray objectAtIndex:favorite_products_title];
        
        //价格判断
        if ([[productArray objectAtIndex:favorite_products_promotion_price] intValue] != 0 && [[productArray objectAtIndex:favorite_products_price] length] > 0) 
        {
            //有优惠价格
            cell.originalLabel.hidden = NO;
            cell.lineView.hidden = NO;
            
            NSString *priceString = [NSString stringWithFormat:@"￥%@",[productArray objectAtIndex:favorite_products_promotion_price]];
            ...
            NSString *originalString = [NSString stringWithFormat:@"/ ￥%@",[productArray objectAtIndex:favorite_products_price]];
        ...
        else
        {
            ...
            NSString *priceString = [NSString stringWithFormat:@"￥%@",[productArray objectAtIndex:favorite_products_price]];
        ...
        //喜欢
        cell.likeLabel.text = [productArray objectAtIndex:favorite_products_likes];
        
        //评论
        cell.commentLabel.text = [productArray objectAtIndex:favorite_products_comment_num];
        
        //图片
        NSString *picUrl = [productArray objectAtIndex:favorite_products_pic];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    int status = [[array objectAtIndex:favorite_products_status] intValue];
    if (status == 1)
    {
//        NSMutableArray *productArray = [[NSMutableArray alloc]init];
//        NSMutableArray *infoArray = [[NSMutableArray alloc]init];
//        [infoArray addObject:[array objectAtIndex:favorite_products_product_id]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_catid]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_title]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_content]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_promotion_price]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_price]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_likes]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_favorites]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_unit]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_salenum]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_comment_num]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_sort_order]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_is_big_pic]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_pic]];
//        [infoArray addObject:[array objectAtIndex:favorite_products_pics]];
//        
//        [productArray addObject:infoArray];
    
        ProductDetailViewController *ProductDetailView = [[ProductDetailViewController alloc] init];
        ProductDetailView.productID = [[array objectAtIndex:favorite_products_product_id] intValue];
        //ProductDetailView.productList = productArray;
        [self.collectView.navigationController pushViewController:ProductDetailView animated:YES];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	_infoId = [[self.listArray objectAtIndex:indexPath.row] objectAtIndex:favorite_products_product_id];
	...
	[[DataManager sharedManager] accessService:jsontestDic command:MEMBER_PRODUCTDELETE_COMMAND_ID accessAdress:@"member/delfavorite.do?param=%@" delegate:self withParam:jsontestDic];
...
- (void)appImageDidLoad:(NSIndexPath *)indexPath withImageType:(int)Type
{
    ...
    if (iconDownloader != nil)
    {
		if(iconDownloader.cardIcon.size.width > 2.0){ 			
            ...
            NSString *imageurl = [[self.listArray objectAtIndex:iconDownloader.indexPathInTableView.row] objectAtIndex:favorite_products_pic];
...
- (void)accessMoreService
{
    ...
    [[DataManager sharedManager] accessService:jsontestDic command:MEMBER_PRODUCTMORELIST_COMMAND_ID accessAdress:@"member/favoritelist.do?param=%@" delegate:self withParam:jsontestDic];
}
...
- (void)accessService
{
    ...
    [[DataManager sharedManager] accessService:jsontestDic command:MEMBER_PRODUCTLIST_COMMAND_ID accessAdress:@"member/favoritelist.do?param=%@" delegate:self withParam:jsontestDic];
}
...
- (void)deleteResult:(NSMutableArray *)resultArray
{
	...
	if (retInt == 1) {
//		[DBOperate deleteData:T_FAVORITE_PRODUCTS tableColumn:@"product_id" columnValue:_infoId];
//        [DBOperate deleteData:T_FAVORITE_PRODUCTS_PIC tableColumn:@"product_id" columnValue:_infoId];
        
        [DBOperate deleteData:T_FAVORITED_PRODUCTS tableColumn:@"product_id" columnValue:_infoId];
