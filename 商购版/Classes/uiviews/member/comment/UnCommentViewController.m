...
#import "UnCommentViewController.h"
#import "Common.h"
...
@interface UnCommentViewController ()

@end

@implementation UnCommentViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (cell == nil) {
        ...
        UIImageView *cellbackgroundImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0.0f , 0.0f , 320 , cellbackgroundImage.size.height)];
        ...
        [cell.contentView addSubview:tempPicView];
        tempPicView.tag = 10;
        ...
        [cell.contentView addSubview:tempTitleLabel];
        ...
        [cell.contentView addSubview:tempPriceLabel];
        ...
        [cell.contentView addSubview:tempOriginalLabel];
        ...
        [cell.contentView addSubview:tempLineView];
        ...
        [likeImage release];
        [cell.contentView addSubview:tempLikeImageView];
        ...
        [cell.contentView addSubview:tempCommentImageView];
        ...
        [cell.contentView addSubview:tempLikeLabel];
        ...
        [cell.contentView addSubview:tempCommentLabel];
...
- (void)writeBtnAction:(id)sender
{
    ...
    NSLog(@"%d",btn.tag);
    int _info = [[[self.listArray objectAtIndex:btn.tag - 10000] objectAtIndex:my_commentlist_id] intValue];
    int _orderId = [[[self.listArray objectAtIndex:btn.tag - 10000] objectAtIndex:my_commentlist_order_id] intValue];
    WriteCommentViewController *write = [[WriteCommentViewController alloc] init];
    write.commentType = CommentTypeMyCommentlist;
    write.infoIdStr = [NSString stringWithFormat:@"%d",_info];
    write.orderIdStr = [NSString stringWithFormat:@"%d",_orderId];
    [myCommentView.navigationController pushViewController:write animated:YES];
    [write release];
}
@end
