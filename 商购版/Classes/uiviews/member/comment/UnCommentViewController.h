...
@interface UnCommentViewController : UIViewController <UITableViewDelegate,UITableViewDataSource,CommandOperationDelegate,MBProgressHUDDelegate,IconDownloaderDelegate>
{
    ...
    UILabel *noLabel;
    MyCommentViewController *myCommentView;
}
