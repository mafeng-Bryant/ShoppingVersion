...
@interface BaiduMapViewController ()<BMKGeoCodeSearchDelegate,BMKLocationServiceDelegate,BMKRouteSearchDelegate,BMKGeoCodeSearchDelegate>
{
    int mapNumber;
...
- (void)viewDidLoad
{
    ...
    _mapView = [[BMKMapView alloc]initWithFrame:CGRectMake(0.f, 0.f, self.view.frame.size.width, self.view.frame.size.height)];
...
- (void)annotationViewBMK:(BMKAnnotationView *)view
{
    ...
    CGPoint poppoint = CGPointMake(viewpoint.x, viewpoint.y);
