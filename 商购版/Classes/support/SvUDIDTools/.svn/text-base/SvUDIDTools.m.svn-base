...
//static const char kKeyChainUDIDAccessGroup[] = "Z5YU76Q99W.cn.yunlai.jw";
...
+ (NSString*)getUDIDFromKeyChain
{
    ...
    NSString *accessGroup = [self getAccessGroupString];//[NSString stringWithUTF8String:kKeyChainUDIDAccessGroup];
    if (accessGroup != nil)
    {
