...
- (UIButton*)closeButton {
	if (!closeButton) {
		...
		[self.closeButton setFrame:CGRectMake(0, 0, 28, 28)];
...
- (CGRect)closeButtonFrame {
	...
	return CGRectMake(f.origin.x - floor(closeButton.frame.size.width*0.5) + 3,
					  f.origin.y - floor(closeButton.frame.size.height*0.5) + 3,
