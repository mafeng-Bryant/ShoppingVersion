...
- (id)init:(int)height
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, height)])
    {
        ...
        containerView = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 280, height - 60)];
        ...
        // add the web view
        webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 320, height - 40)];
        ...
        [indicatorView setCenter:CGPointMake(160, height * 0.5)];
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    {
        [self setFrame:CGRectMake(0, 0, self.viewHeight, 320)];
        [panelView setFrame:CGRectMake(10, 30, self.viewHeight - 20, 280)];
        [containerView setFrame:CGRectMake(10, 10, self.viewHeight - 40, 260)];
        [webView setFrame:CGRectMake(0, 0, self.viewHeight - 40, 260)];
        [indicatorView setCenter:CGPointMake(self.viewHeight * 0.5, 160)];
    }
    else
    {
        [self setFrame:CGRectMake(0, 0, 320, self.viewHeight)];
        [panelView setFrame:CGRectMake(10, 30, 300, self.viewHeight - 40)];
        [containerView setFrame:CGRectMake(10, 10, 280, self.viewHeight - 60)];
        [webView setFrame:CGRectMake(0, 0, 280, self.viewHeight - 60)];
        [indicatorView setCenter:CGPointMake(160, self.viewHeight * 0.5)];
    }
    
    [self setCenter:CGPointMake(160, self.viewHeight * 0.5)];
