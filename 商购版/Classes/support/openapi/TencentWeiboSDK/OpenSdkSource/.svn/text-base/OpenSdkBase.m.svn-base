 ...
 * Todo：请正确填写您的客户端ip
 */
#define ClientIpValue @"http://yunlai.cn"

/*
 * Todo: 请填写您的应用的appkey和appsecret
 */
#define oauthAppKey @"801106679"
#define oauthAppSecret @"14e3e1188d69231e59f6c98d4a9a5527"

/*
 * Todo：请正确填写您的应用网址，否则将导致授权失败
 */
#define redirect_uri @"http://our.3g.yunlai.cn/app"
